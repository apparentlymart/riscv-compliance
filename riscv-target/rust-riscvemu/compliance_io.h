...
#define RVTEST_IO_WRITE_STR(_SP, _STR)    \
  LOCAL_IO_PUSH(_SP).section.data.string; \
  20001 :.string _STR;                    \
  .section.text.init;                     \
  la a0, 20001b;                          \
  jal FN_WriteStr;                        \
...
FN_WriteA0 : mv t0,
    ...
    10 10000 : andi a0,
               ...
               10001f addi a0,
               a0,
               'a' - 10 j 10002f 10001 : addi a0,
               a0,
               '0' 10002 : LOCAL_IO_PUTC(a0) srli t2,
                           t2,
                           4 addi t1,
                           t1,
                           -1 bnez t1,
